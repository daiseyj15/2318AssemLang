##########################################################################
# Daisey Jaramillo, CS 2318-003, Assignment 2 Part 1 Program B
############################
...
main:
			...
			ori $t3, $t1, 0x20	#force lowercase of $t1 and stores in $t3
			ori $t4, $t2, 0x20	#force lowercase of $t2 and stores in $t4
			xor $a0, $t3, $t4	#comparing contents of $t3 and $t4, if they are the same they return 0 
